 ...
 * {@link Database} is not abstract as it is useful on its own.
 *
 ...
 * @subpackage SoftwareTemplate
 */
abstract class Software extends Database {
  /** @var SwissArmyKnife */
   ...
   * Constructor
   *
   * @param SwissArmyKnife  $owner
   * @param Core            $core
   * @param Type_Template   $template
   ...
   * @uses init()
   */
  public function __construct(SwissArmyKnife $owner, Core $core, Type_Template $template, $database = "", $prefix = "", $username = "", $password = "", $hostname = "localhost") {
    parent::__construct($owner, $database, $username, $password, $hostname);
    //$this->owner = $owner;
    $this->core = $core;
